...
abstract contract InvariantsSpec {
    ...
    string constant BASE_INVARIANT_E = "BASE_INVARIANT_E: If reserve is frozen pending ltv cannot be 0";
    ...
    string constant BORROWING_INVARIANT_A = "BORROWING_INVARIANT_A: sum of all user debt == 0 <=> totalBorrowed == 0";
