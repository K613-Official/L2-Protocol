...
abstract contract PostconditionsSpec {
    ...
    string constant BASE_GPOST_B = "BASE_GPOST_B: Only a subset of actions can update the interest rate of a reserve";

    string constant BASE_GPOST_C =
        "BASE_GPOST_C: Only a subset of actions can update virtualUnderlyingBalance rate of a reserve";

    string constant BASE_GPOST_D = "BASE_GPOST_D: Only a subset of actions can update the liquidity index of a reserve";

    string constant BASE_HPOST_E = "BASE_HPOST_E: After unpausing a reserve gracePeriod should be updated correctly";
    ...
    string constant BORROWING_HSPOST_A = "BORROWING_HSPOST_A: User liability should always decrease after repayment";
    ...
    string constant ERC20_HSPOST_A = "ERC20_HSPOST_A: After a successful transfer, sender should remain healthy";

    string constant ERC20_HSPOST_B = "ERC20_HSPOST_B: Before a successful transfer, sender should be healthy";

    string constant ERC20_HSPOST_C = "ERC20_HSPOST_C: After a successful transferFrom, from should remain healthy";

    string constant ERC20_HSPOST_D = "ERC20_HSPOST_D: Before a successful transferFrom, from should be healthy";
